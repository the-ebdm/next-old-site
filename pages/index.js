      ...
      <div id="profile" className="profile w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl mx-6 lg:mx-0">
        <div className="p-4 md:p-12 text-center lg:text-left">
          ...
          <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
            ...
            <Tippy content="Basically, I'm a massive fucking nerd"><span>{flags['job-title']}</span></Tippy>
          </p>
          <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
            ...
            <Tippy content="Middle of fuckin' nowhere mate"><span>{flags['location']}</span></Tippy>
          </p>
...
export async function getServerSideProps({ req }) {
  ...
  let flags = await client.allFlagsState({
    'key': req.cookies.ajs_anonymous_id,
    'anonymous': true
  })
